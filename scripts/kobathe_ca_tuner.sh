...
export KOBATHE_LM_SWITCH_STEP="$(getj KOBATHE_LM_SWITCH_STEP)"
export KOBATHE_LM_ADAPTIVE_SWITCH="$(getj KOBATHE_LM_ADAPTIVE_SWITCH)"
export KOBATHE_LM_ASW_CLEAN_M="$(getj KOBATHE_LM_ASW_CLEAN_M)"
export KOBATHE_LM_ASW_LADDER="$(getj KOBATHE_LM_ASW_LADDER)"
export KOBATHE_LM_ASW_CLEAN_MU="$(getj KOBATHE_LM_ASW_CLEAN_MU)"
