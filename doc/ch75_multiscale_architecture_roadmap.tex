...
This chapter records the pre-publication architectural audit and roadmap.  The
current normative multiscale contracts and implemented semantics are given in
