...
On a modern 8-core machine the full build takes approximately 4--6 minutes.
The project no longer fetches the legacy C++ plotting dependency as part of
the configured dependency surface; plotting for validation and post-processing
is handled outside the core build through CSV export plus Python/VTK-oriented
tooling.
The following executables are produced in the build directory:
