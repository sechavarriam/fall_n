...
\texttt{fall\_n} nonlinear finite element library.  It focuses on the
implementation of simplex (tetrahedral) finite elements, numerical integration
strategies on simplicial domains, and the engineering decisions made to ensure
...
\begin{itemize}[nosep]
  ...
  \item Volume-weighted (SPR-type) nodal averaging as a robust projection
        method;
  \item A bug fix in PETSc~3.24.5 \texttt{section.c} that affects higher-order
        simplex elements.
\end{itemize}
