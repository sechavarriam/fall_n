...
\(\delta \mathbf{u}_c = \mathbf{T}\,\delta \mathbf{q}\), the condensed
section operator is
\begin{equation}
  ...
  \right)\mathbf{T}.
\end{equation}
The implementation evaluates this operator through a sparse solve of the six
