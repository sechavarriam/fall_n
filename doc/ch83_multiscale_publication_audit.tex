...
\begin{itemize}
  ...
  \item \texttt{SectionHomogenizedResponse}: homogenised forces, tangent,
    ...
    linearisation provenance, tangent-column validity, and perturbation
    sizes when the finite-difference fallback is actually used;
...
an explicit seam for future replacement of the current dense condensation /
finite-difference fallback pair by even more advanced local linearisation
strategies.
