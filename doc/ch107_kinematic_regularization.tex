...
%% ROUND4-MESH-RESULTS: block metrics of p1_ls_sec444 (transverse-only)
%% and p2_ls_448_full (full-protocol z-refined) vs the reference, and
%% the round's verdict on where the regularization actually lives.
