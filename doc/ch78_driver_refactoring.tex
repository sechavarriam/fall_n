...
This chapter describes the first migration of driver logic into a multiscale
orchestrator.  The current publication-oriented API and behaviour are specified
normatively in Chapter~\ref{ch:multiscale-publication-audit}.
