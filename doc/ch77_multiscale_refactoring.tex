...
This chapter documents an earlier refactoring milestone.  It remains useful as
implementation provenance, but the authoritative description of the current
public multiscale subsystem is Chapter~\ref{ch:multiscale-publication-audit}.
