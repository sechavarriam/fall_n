...
Phase~1 (semantic rename, \S\ref{sec:phase1-rename}) and
Phase~2 (thread safety, \S\ref{sec:phase2-thread-safety}) have been
implemented and verified.
Phases~3--6 remain for future work and will follow the same
