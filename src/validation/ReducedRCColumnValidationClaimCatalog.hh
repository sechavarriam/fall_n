...
canonical_reduced_rc_column_validation_claim_table() noexcept
{
    ...
    return std::to_array({
        ...
        make_reduced_rc_column_validation_claim_row(
            ...
            "ReducedRCColumnStructuralBaseline.hh/.cpp + axial_smoke branch in test_reduced_rc_column_structural_matrix.cpp + scripts/opensees_reduced_rc_column_reference.py with an explicit external mapping policy",
            "finite_runtime_smoke_under_constant_axial_preload plus staged external OpenSeesPy column reference contract with policy-level manifest metadata",
        ...
        make_reduced_rc_column_validation_claim_row(
            ...
            "ReducedRCColumnStructuralBaseline.hh/.cpp + TableCyclicValidationSupport::write_csv(...) + scripts/opensees_reduced_rc_column_reference.py with declared cyclic-diagnostic policy support",
            "runtime_output_contract_for_hysteresis_csv plus staged external OpenSeesPy hysteresis contract with explicit constitutive-policy reporting and benchmark-overlay plotting support",
        ...
        make_reduced_rc_column_validation_claim_row(
            ...
            "runtime_output_contract_for_base_side_moment_curvature_csv_plus_preload_consistent_matrix_wide_section_closure_bundle_plus constitutive_mapping_audit_bundle_with_declared_monotonic_and_cyclic_external_section_policies",
        ...
        make_reduced_rc_column_validation_claim_row(
            ...
            "ReducedRCColumnStructuralBaseline.hh/.cpp + ReducedRCColumnStructuralMatrixCatalog.hh + ReducedRCColumnNodeRefinementStudy.hh/.cpp + ReducedRCColumnCyclicNodeRefinementStudy.hh/.cpp + ReducedRCColumnCyclicContinuationSensitivityStudy.hh/.cpp + ReducedRCColumnCyclicQuadratureSensitivityStudy.hh/.cpp",
            "full_monotonic_internal_node_refinement_bundle_against_highest_n_reference_is_available_over_all_runtime_ready_n2_to_n10_slices_the_full_cyclic_refinement_matrix_also_exists_over_n2_to_n10_x_gauss_lobatto_radau_left_radau_right_with_36_of_36_completed_cases_and_8_of_36_representative_passes_the_guarded_displacement_control_comparison_establishes_reversal_guarded_incremental_displacement_control_as_the_declared_structural_policy_and_the_cyclic_family_spread_bundle_now_confirms_that_remaining_reversal_drift_cannot_be_honestly_attributed_to_missing_quadrature_coverage",
        ...
        make_reduced_rc_column_validation_claim_row(
            ...
            "BeamAxisQuadrature.hh + ReducedRCColumnStructuralBaseline.hh/.cpp + ReducedRCColumnQuadratureSensitivityStudy.hh/.cpp + ReducedRCColumnCyclicQuadratureSensitivityStudy.hh/.cpp",
            "full_monotonic_internal_quadrature_sensitivity_bundle_against_gauss_legendre_reference_is_available_over_all_runtime_ready_n2_to_n10_slices_and_the_full_cyclic_family_spread_bundle_now_also_exists_under_reversal_guarded_incremental_displacement_control_with_36_of_36_completed_cases_and_14_of_36_representative_passes_the_frontier_is_concentrated_in_reversal_sensitive_moment_history_spread_of_lobatto_and_radau_variants_not_in_axial_force_closure_or_reference_family_execution",
            "monotonic_and_cyclic_base_side_moment_curvature_spread_and_controlling_station_shift_vs_quadrature_family",
            "reduced_column_quadrature_sensitivity_suite",
            Readiness::benchmark_pending,
