...
canonical_reduced_rc_column_validation_claim_table() noexcept
{
    ...
    return std::to_array({
        ...
        make_reduced_rc_column_validation_claim_row(
            ...
            "ReducedRCColumnStructuralBaseline.hh/.cpp + moment_curvature_base.csv",
            "runtime_output_contract_for_base_side_moment_curvature_csv",
        ...
        make_reduced_rc_column_validation_claim_row(
            ...
            "ReducedRCColumnStructuralBaseline.hh/.cpp + ReducedRCColumnStructuralMatrixCatalog.hh",
            "runtime_family_exists_but_no_refinement_benchmark_table_yet",
            "envelope_strength_stiffness_and_loop_shape_vs_N",
            "reduced_column_node_refinement_suite",
        ...
        make_reduced_rc_column_validation_claim_row(
            ...
            "BeamAxisQuadrature.hh + ReducedRCColumnStructuralBaseline.hh/.cpp",
            "quadrature_family_exists_and_smoke_runs_but_no_sensitivity_benchmark_yet",
            "loop_shape_strength_and_dissipation_vs_quadrature_family",
            "reduced_column_quadrature_sensitivity_suite",
            Readiness::benchmark_pending,
