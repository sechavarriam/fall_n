...
canonical_reduced_rc_column_benchmark_trace_table() noexcept
{
    ...
    return std::to_array({
        ...
        make_reduced_rc_column_benchmark_trace_row(
            ...
            "ReducedRCColumnMomentCurvatureClosureMatrix + preload-consistent moment_curvature_closure_matrix_summary.csv",
            "base_side_moment_curvature_envelope",
        ...
        make_reduced_rc_column_benchmark_trace_row(
            ...
            "ReducedRCColumnNodeRefinementStudy + ReducedRCColumnStructuralBaseline over N=2..10",
            "base_side_moment_curvature_and_terminal_moment_drift_vs_N",
            "tangent_and_secant_drift_against_highest_N_reference_per_quadrature",
            "internal runtime matrix interpreted as a convergence study rather than a single smoke slice",
            "observables show stable refinement trends over the full runtime-ready matrix and any residual base-side-station dependence is interpreted explicitly rather than hidden",
        ...
        make_reduced_rc_column_benchmark_trace_row(
            ...
            "ReducedRCColumnQuadratureSensitivityStudy + ReducedRCColumnStructuralBaseline over Gauss, Lobatto, and Radau families",
            "base_side_moment_curvature_spread_over_quadrature_family",
            "controlling_station_location_shift_and_family_spread",
