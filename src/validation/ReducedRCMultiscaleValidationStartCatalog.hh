...
[[nodiscard]] constexpr auto canonical_reduced_rc_vtk_field_table() noexcept
{
    ...
    return std::to_array({
        ...
        ReducedRCVTKFieldSpec{
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = true,
            .interpretation = "second bending curvature component for biaxial seismic replay"},
        ReducedRCVTKFieldSpec{
        ...
        ReducedRCVTKFieldSpec{
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = true,
            .interpretation = "second bending moment component paired with curvature_z"},
        ReducedRCVTKFieldSpec{
            .name = "roof_displacement",
            .scale_kind = Scale::structural_global,
            .location_kind = Location::structural_axis,
            .components = 3,
            .required_for_pseudo_time = false,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "global roof displacement orbit used in seismic comparison"},
        ReducedRCVTKFieldSpec{
            .name = "story_drift_ratio",
            .scale_kind = Scale::structural_global,
            .location_kind = Location::structural_axis,
            .components = 1,
            .required_for_pseudo_time = false,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "inter-storey drift envelope used to rank critical macro sites"},
        ReducedRCVTKFieldSpec{
            .name = "fe2_activation_state",
            .scale_kind = Scale::multiscale_coupled,
            .location_kind = Location::structural_section,
            .components = 1,
            .required_for_pseudo_time = true,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = true,
            .interpretation = "site activation marker linking global sections to managed local XFEM models"},
        ReducedRCVTKFieldSpec{
            .name = "gauss_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            .components = 1,
            .required_for_pseudo_time = false,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "stable local material-point identifier for publication Gauss clouds"},
        ReducedRCVTKFieldSpec{
            .name = "element_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "local continuum element carrying each publication Gauss point"},
        ReducedRCVTKFieldSpec{
            .name = "material_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "material identifier attached to publication Gauss points"},
        ReducedRCVTKFieldSpec{
            .name = "site_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "managed local site identifier attached to publication Gauss points"},
        ReducedRCVTKFieldSpec{
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "macro element identifier attached to publication Gauss points"},
        ReducedRCVTKFieldSpec{
            .name = "displacement",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "Gauss-cloud displacement interpolated from local nodes for Warp By Vector"},
        ReducedRCVTKFieldSpec{
            .name = "qp_strain_voigt",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            .components = 6,
            .required_for_pseudo_time = false,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "raw quadrature strain tensor used to audit local kinematics"},
        ReducedRCVTKFieldSpec{
            .name = "qp_stress_voigt",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            .components = 6,
            .required_for_pseudo_time = false,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "raw quadrature stress tensor used to audit local material response"},
        ReducedRCVTKFieldSpec{
            .name = "qp_damage",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "quadrature damage indicator, zero-filled when the material has not activated damage"},
        ReducedRCVTKFieldSpec{
            .name = "qp_num_cracks",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "number of active cracks at a material point, zero-filled before fracture activation"},
        ReducedRCVTKFieldSpec{
            .name = "qp_crack_normal_1",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            .components = 3,
            .required_for_pseudo_time = false,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "first material-point crack normal for Gauss-cloud orientation audit"},
        ReducedRCVTKFieldSpec{
            .name = "qp_crack_closed_1",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::continuum_gauss_point,
            .components = 1,
            .required_for_pseudo_time = false,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "closed/open state of the first material-point crack family"},
        ReducedRCVTKFieldSpec{
            .name = "crack_opening",
            .scale_kind = Scale::xfem_local,
        ...
        ReducedRCVTKFieldSpec{
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "visual threshold flag used to reproduce filtered publication crack surfaces"},
        ReducedRCVTKFieldSpec{
            .name = "displacement",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "crack-surface point displacement used for ParaView Warp By Vector"},
        ReducedRCVTKFieldSpec{
            .name = "crack_opening_vector",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            .components = 3,
            .required_for_pseudo_time = true,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "opening vector equal to scalar opening times the crack normal"},
        ReducedRCVTKFieldSpec{
            .name = "crack_normal",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = true,
            .interpretation = "local crack plane normal used to audit fracture orientation"},
        ReducedRCVTKFieldSpec{
            .name = "crack_state",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
        ...
        ReducedRCVTKFieldSpec{
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "discontinuity-plane identifier for XFEM multi-plane surfaces or Ko-Bathe crack families"},
        ReducedRCVTKFieldSpec{
            .name = "crack_sequence_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            .components = 1,
            .required_for_pseudo_time = true,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "ordered discontinuity sequence used to trace multi-plane XFEM activation in ParaView"},
        ReducedRCVTKFieldSpec{
            .name = "crack_activation_step",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            .components = 1,
            .required_for_pseudo_time = true,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "local step at which the XFEM discontinuity plane became active"},
        ReducedRCVTKFieldSpec{
            .name = "crack_activation_time",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            .components = 1,
            .required_for_pseudo_time = true,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "pseudo-time at which the XFEM discontinuity plane became active"},
        ReducedRCVTKFieldSpec{
            .name = "crack_source_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            .components = 1,
            .required_for_pseudo_time = true,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "integer XFEM plane source: 0 legacy, 1 prescribed, 2 automatic"},
        ReducedRCVTKFieldSpec{
            .name = "crack_family_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            .components = 1,
            .required_for_pseudo_time = false,
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "publication crack-family identifier used by Ko-Bathe Hex27 filtered surfaces"},
        ReducedRCVTKFieldSpec{
            .name = "site_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "managed local site identifier for synchronized global-local VTK review"},
        ReducedRCVTKFieldSpec{
            .name = "parent_element_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::xfem_crack_surface,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "macro element that promoted the managed local fracture site"},
        ReducedRCVTKFieldSpec{
        ...
        ReducedRCVTKFieldSpec{
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "truss rebar axial strain shown on tubular ParaView bars"},
        ReducedRCVTKFieldSpec{
            .name = "axial_stress",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::rebar_line,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "truss rebar axial stress shown on tubular ParaView bars"},
        ReducedRCVTKFieldSpec{
            .name = "yield_ratio",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::rebar_line,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "absolute axial stress divided by steel yield stress"},
        ReducedRCVTKFieldSpec{
            .name = "bar_area",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::rebar_line,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "longitudinal bar area used to size/trace rebar carriers"},
        ReducedRCVTKFieldSpec{
            .name = "TubeRadius",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::rebar_line,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "ParaView tube radius attached to each rebar cell"},
        ReducedRCVTKFieldSpec{
            .name = "bar_id",
            .scale_kind = Scale::xfem_local,
            .location_kind = Location::rebar_line,
            ...
            .required_for_physical_time = true,
            .required_for_multiscale_replay = false,
            .interpretation = "stable rebar identifier for publication coloring and filtering"},
        ReducedRCVTKFieldSpec{
