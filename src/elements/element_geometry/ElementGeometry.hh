...
public:
    ...
    DeprecatedSequentialVector           integrate(std::function<DeprecatedSequentialVector(Array)>&& f) const {return pimpl()->integrate(std::forward<std::function<DeprecatedSequentialVector(Array)>>(f));};
