...
/*
    auto get_element_topology(std::map<std::size_t, std::vector<std::size_t>>& elementTags)
    {
...
*/
    ...
    void procces_elements(){ //Esto procesa tanto elemento 2d (facets) como 3d  (cells) TODO:FIX. 
