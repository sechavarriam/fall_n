...
// =============================================================================
//  ReadGmsh.hh — Gmsh MSH 4.1 ASCII reader
// =============================================================================
//
//  Reads a Gmsh MSH file (format 4.1, ASCII) into typed section views and
//  builds a Domain. Each MSH section has its own info struct
//  (MeshFormatInfo, PhysicalNamesInfo, EntitiesInfo, NodesInfo, ElementInfo,
//  ...); the reader locates the section keywords and hands each block to its
//  parser. Binary MSH and legacy MSH 2.x are not supported.
//
// =============================================================================
