...
int main(){
    ...
    elements.emplace_back(ElementBase<dim,8 ,42> {1 , {1,2,3,4,5,6,7,8}});   
    elements.emplace_back(ElementBase<dim,3 ,42> {2 , {1,2,3}});
    elements.emplace_back(ElementBase<dim,5 ,42> {4 , {1,2,3,4,5}});
    elements.emplace_back(ElementBase<dim,7 ,42> {5 , {1,2,3,4,5,6,7}});
